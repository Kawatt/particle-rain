...
public class DeadBushParticle extends DustMoteParticle {
    ...
    public void render(VertexConsumer vertexConsumer, Camera camera, float tickPercentage) {
        ...
        for (Quaternionf quaternion : faceArray) {
            ...
            float lerp_x = (float)(Mth.lerp((double)tickPercentage, this.xo, this.x) - camPos.x());
            float lerp_y = (float)(Mth.lerp((double)tickPercentage, this.yo, this.y) - camPos.y());
            float lerp_z = (float)(Mth.lerp((double)tickPercentage, this.zo, this.z) - camPos.z());
            ...
            for(int k = 0; k < 4; ++k) {
                ...
                vector3f.add(lerp_x, lerp_y, lerp_z);
            }
